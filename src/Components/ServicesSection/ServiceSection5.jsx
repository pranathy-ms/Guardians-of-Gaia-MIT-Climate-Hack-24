...
const ServiceSection5 = ({ data }) => {
  ...
  const settings = {
    ...
    dotsClass: `cs_pagination cs_style_2 cs_color_1 cs_show_1100`,
    responsive: [
      {
        breakpoint: 1550,
        settings: {
  ...
  return (
    <>
      ...
      <div className="cs_slider cs_style_1 cs_slider_gap_24 cs_ptb_12">
          ...
          <Slider {...settings} ref={sliderRef}>
            {data.sliderData.map((slide, index) => (
              <div className="cs_slide" key={index}>
                <div className="cs_iconbox cs_style_5 text-center cs_accent_bg">
                  <div className="cs_iconbox_icon cs_center cs_mb_27">
                    <img src={slide.icon} alt={slide.title} />
                  </div>
                  <h3 className="cs_iconbox_title cs_white_color cs_fs_28 cs_semibold cs_mb_50">
        ...
        <div className="cs_slider_arrows cs_style_1 cs_type_1 cs_hide_1100">
          <div
