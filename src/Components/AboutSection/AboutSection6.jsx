...
const AboutSection6 = ({ data, color, about_content_style_2, btnStyle }) => {
          ...
          <div className="col-lg-6 d-flex align-items-center">
            <div className="cs_pl_75">
              ...
              <SectionHeading
                ...
                titleVerint={'cs_mb_30'}
                descriptionVerint={'cs_mb_30'}
                color={color ? color : ''}
              />
              {!about_content_style_2 ? (
              ...
              <Button
                ...
                variant={btnStyle ? btnStyle : 'cs_btn cs_style_1'}
              />
              <Spacing lg={50} md={0} />
            </div>
          </div>
